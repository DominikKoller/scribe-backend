...
const USER_COMMENT_CALL_DAY_LIMIT = process.env.USER_COMMENT_CALL_DAY_LIMIT ? parseInt(process.env.USER_COMMENT_CALL_DAY_LIMIT) : 10;
const ANON_USER_COMMENT_CALL_DAY_LIMIT = process.env.ANON_USER_COMMENT_CALL_DAY_LIMIT ? parseInt(process.env.ANON_USER_COMMENT_CALL_DAY_LIMIT) : 10;
const GLOBAL_COMMENT_CALL_DAY_LIMIT = process.env.GLOBAL_COMMENT_CALL_DAY_LIMIT ? parseInt(process.env.GLOBAL_COMMENT_CALL_DAY_LIMIT) : 100;
const GLOBAL_ANON_COMMENT_CALL_DAY_LIMIT = process.env.GLOBAL_ANON_COMMENT_CALL_DAY_LIMIT ? parseInt(process.env.GLOBAL_ANON_COMMENT_CALL_DAY_LIMIT) : 20;
